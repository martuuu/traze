...
export default function TreatmentPage() {
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20 max-w-4xl mx-auto">
            <div>
                 <h1 className="text-3xl font-black text-slate-900 tracking-tight">Mi Tratamiento</h1>
                 <p className="text-slate-500">Esquema terapéutico y cultivos asignados actualmente.</p>
            </div>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="bg-white p-3 rounded-lg border border-teal-100 flex items-center gap-3 shadow-sm">
                                    ...
                                    <div>
                                        <p className="font-bold text-slate-800">Aceite CBD 10%</p>
                                        <p className="text-xs text-slate-500">0.5ml cada 12hs</p>
                                    </div>
                                </div>
                                <div className="bg-white p-3 rounded-lg border border-teal-100 flex items-center gap-3 shadow-sm">
                                    <Clock className="text-teal-500" size={20}/>
                                    <div>
                                        <p className="font-bold text-slate-800">Flores (Vaporización)</p>
                                        <p className="text-xs text-slate-500">0.3g SOS ante crisis</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div>
                <h2 className="text-xl font-bold text-slate-900 mb-4 flex items-center gap-2">
                    <Sprout className="text-emerald-600" /> Cultivos Asignados
                </h2>
                    ...
                    <Card className="border-slate-100 overflow-hidden group hover:shadow-lg transition-all duration-300">
                        <div className="h-40 bg-[url('https://images.unsplash.com/photo-1603909223429-69bb7101f420?ixlib=rb-4.0.3')] bg-cover bg-center relative">
                            ...
                            <div className="absolute bottom-4 left-4 text-white">
                                ...
                                <p className="text-emerald-200 text-xs font-mono">Lote AR-4402</p>
                            </div>
                        </div>
                        <CardContent className="p-6">
                            <div className="flex justify-between items-center mb-4">
                                <Badge className="bg-purple-100 text-purple-700 hover:bg-purple-200 border-purple-200">Floración</Badge>
                                <span className="text-xs font-bold text-slate-400">Día 45</span>
                            </div>
                            <div className="w-full bg-slate-100 rounded-full h-2 mb-2">
                                <div className="bg-purple-500 h-2 rounded-full w-[70%]" />
                            </div>
                            <p className="text-xs text-slate-500 text-center">Cosecha estimada: <strong>15 Octubre</strong></p>
                            
                            <div className="mt-4 grid grid-cols-2 gap-2 text-center">
                                <div className="p-2 bg-slate-50 rounded-lg">
                                    <p className="text-[10px] text-slate-400 font-bold uppercase">THC Est.</p>
                                    <p className="font-bold text-slate-700">18%</p>
                                </div>
                                <div className="p-2 bg-slate-50 rounded-lg">
                                    <p className="text-[10px] text-slate-400 font-bold uppercase">CBD Est.</p>
                     ...
                     <Card className="border-slate-100 overflow-hidden group hover:shadow-lg transition-all duration-300">
                        ...
                        <CardContent className="p-6">
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <span className="text-xs font-bold text-slate-400">Día 3</span>
                            </div>
                            <div className="w-full bg-slate-100 rounded-full h-2 mb-2">
                                <div className="bg-amber-500 h-2 rounded-full w-[20%]" />
                            </div>
                            <p className="text-xs text-slate-500 text-center">Disponible estimada: <strong>23 Septiembre</strong></p>
                            
                             <div className="mt-4 grid grid-cols-2 gap-2 text-center">
                                <div className="p-2 bg-slate-50 rounded-lg">
                                    <p className="text-[10px] text-slate-400 font-bold uppercase">THC Est.</p>
                                    <p className="font-bold text-slate-700">22%</p>
                                </div>
                                <div className="p-2 bg-slate-50 rounded-lg">
                                    <p className="text-[10px] text-slate-400 font-bold uppercase">CBD Est.</p>
                                    <p className="font-bold text-slate-700">0.5%</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
